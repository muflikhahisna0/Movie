        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item lala">
                    <a class="nav-link font-weight-bold text-warning" href="/film/">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link lala font-weight-bold text-warning" href="/film/movie/">Movie</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link lala font-weight-bold text-warning" href="/film/about/">About</a>
                </li>
